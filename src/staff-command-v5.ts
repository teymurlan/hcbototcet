...
html.hc-command-v5 .hc-v5-pref-group{margin-top:13px}.hc-v5-pref-group>strong{display:block;margin:0 2px 7px;font-size:10.5px;color:#6e737b}.hc-v5-pref-row{display:grid;grid-template-columns:repeat(3,1fr);gap:6px}.hc-v5-pref-row.two{grid-template-columns:repeat(2,1fr)}.hc-v5-pref-row button{appearance:none;border:0;background:#fff;border-radius:13px;min-height:40px;padding:7px;font-size:9.3px;font-weight:850;color:#646a72}.hc-v5-pref-row button.on{background:#111820;color:#fff}.hc-v5-sheet-actions{display:grid;grid-template-columns:1fr 1.5fr;gap:8px;margin-top:14px}.hc-v5-sheet-actions button{min-height:44px;border:0;border-radius:15px;font-weight:900}.hc-v5-sheet-actions .cancel{background:#e6e7e9;color:#4e535a}.hc-v5-sheet-actions .save{background:#111820;color:#fff}
html.hc-ui-density-compact #main>.card,html.hc-ui-density-compact #main>.order-card,html.hc-ui-density-compact #main>.task-card{padding-top:9px!important;padding-bottom:9px!important;margin-bottom:5px!important}html.hc-ui-density-compact .section-title{margin-top:12px!important;margin-bottom:6px!important}
html.hc-ui-motion-gentle #main.hc-motion-ready *,html.hc-ui-motion-gentle .hc-catalog-v2-appear,html.hc-ui-motion-gentle .hc-catalog-appear{animation:none!important}html.hc-ui-motion-off #main.hc-motion-ready *,html.hc-ui-motion-off .hc-nav-indicator,html.hc-ui-motion-off .hc-toast{animation:none!important;transition:none!important}
html.hc-ui-text-large #main .title{font-size:16px!important}html.hc-ui-text-large #main .sub{font-size:13px!important}html.hc-ui-text-large #main .section-title h2{font-size:21px!important}
html.hc-ui-nav-compact .nav{left:12px!important;right:12px!important;bottom:8px!important}html.hc-ui-nav-compact .navin{min-height:62px!important;padding:3px 5px!important;border-radius:22px!important}html.hc-ui-nav-compact .nav button{min-height:52px!important;font-size:8.8px!important}html.hc-ui-nav-compact .nav button i{width:31px!important;height:31px!important}
html.hc-ui-accent-graphite .nav button.on,html.hc-ui-accent-graphite .hc-v5-template-save,html.hc-ui-accent-graphite .hc-v5-send{background:#24282f!important}html.hc-ui-accent-mint .nav button.on,html.hc-ui-accent-mint .hc-v5-template-save,html.hc-ui-accent-mint .hc-v5-send{background:#14856a!important}
html.hc-command-v5 .hc-v5-app-preview{margin-bottom:12px;padding:12px;border-radius:20px;background:#fff;display:grid;gap:8px}.hc-v5-app-preview-top{display:flex;align-items:center;justify-content:space-between}.hc-v5-app-preview-top strong{font-size:12px}.hc-v5-app-preview-top span{font-size:9px;color:#8b9098}.hc-v5-preview-phone{border-radius:18px;background:#eef0f3;padding:9px;display:grid;gap:6px}.hc-v5-preview-row{display:grid;grid-template-columns:repeat(3,1fr);gap:5px}.hc-v5-preview-row i{height:24px;border-radius:8px;background:#fff}.hc-v5-preview-card{height:38px;border-radius:11px;background:#fff}.hc-v5-preview-nav{height:28px;border-radius:10px;background:rgba(255,255,255,.88);display:grid;grid-template-columns:repeat(5,1fr);gap:4px;padding:4px}.hc-v5-preview-nav i{border-radius:6px;background:#dfe3e8}.hc-v5-preview-nav i:first-child{background:var(--v5-blue)}html.hc-ui-accent-graphite .hc-v5-preview-nav i:first-child{background:#24282f}html.hc-ui-accent-mint .hc-v5-preview-nav i:first-child{background:#14856a}

/* Notification center V5. */
html.hc-command-v5 .hc-v3-notify-page{gap:10px!important}
html.hc-command-v5 .hc-v3-tabs{grid-template-columns:repeat(4,minmax(0,1fr))!important;border-radius:18px!important;padding:4px!important;gap:3px!important}
html.hc-command-v5 .hc-v3-tabs button{font-size:10px!important;padding:8px 5px!important;min-height:39px!important;border-radius:13px!important}
...
html.hc-command-v5 .hc-v5-channel{display:flex;align-items:center;justify-content:space-between;gap:14px;background:#fff;border-radius:20px;padding:14px 13px;min-height:66px}.hc-v5-channel strong{display:block;font-size:13px}.hc-v5-channel p{margin:4px 0 0;font-size:10.5px;color:#858a92;line-height:1.4}.hc-v5-toggle{position:relative;flex:none;width:45px;height:28px}.hc-v5-toggle input{position:absolute;opacity:0}.hc-v5-toggle i{position:absolute;inset:0;border-radius:999px;background:#d6d8dc}.hc-v5-toggle i:after{content:'';position:absolute;width:24px;height:24px;left:2px;top:2px;border-radius:50%;background:#fff;box-shadow:0 1px 4px rgba(0,0,0,.16);transition:transform .18s}.hc-v5-toggle input:checked+i{background:#34c759}.hc-v5-toggle input:checked+i:after{transform:translateX(17px)}
html.hc-command-v5 .hc-v5-template-picker{display:flex;gap:6px;overflow-x:auto;scrollbar-width:none;padding-bottom:2px}.hc-v5-template-picker::-webkit-scrollbar{display:none}.hc-v5-template-picker button{appearance:none;border:0;border-radius:13px;background:#fff;padding:10px 12px;font-size:10.5px;font-weight:850;color:#6e737b;white-space:nowrap;min-height:40px}.hc-v5-template-picker button.on{background:#111820;color:#fff}.hc-v5-template-card{background:#fff;border-radius:22px;padding:14px;display:grid;gap:10px}.hc-v5-template-top{display:flex;justify-content:space-between;align-items:center;gap:8px}.hc-v5-template-top strong{font-size:12.5px}.hc-v5-template-actions{display:flex;gap:5px}.hc-v5-template-actions button{border:0;border-radius:10px;background:#eef0f2;padding:6px 8px;font-size:8.5px;font-weight:850;color:#5f646c}.hc-v5-template-card>p{margin:-3px 0 0;color:#898e96;font-size:9.3px}.hc-v5-template-card textarea{width:100%;box-sizing:border-box;min-height:190px;border:1px solid #e1e3e7;border-radius:16px;background:#f7f8f9;padding:13px 14px;font:inherit;font-size:13px;line-height:1.5;outline:none;resize:vertical}.hc-v5-vars{display:flex;gap:5px;overflow:auto;scrollbar-width:none}.hc-v5-vars button{border:0;border-radius:999px;background:#eef5ff;color:#2266c8;padding:8px 10px;font-size:9.5px;font-weight:800;white-space:nowrap;min-height:34px}.hc-v5-preview{border-radius:16px;background:#eff1f3;padding:13px;font-size:11.5px;line-height:1.5;color:#4e535a;white-space:normal}.hc-v5-template-save{min-height:46px;border:0;border-radius:14px;background:#111820;color:#fff;font-size:11.5px;font-weight:900}
...
(function(){
 ...
 var queued=false,notifyTab='feed',noticeFilter='all',noticeQuery='',notices=null,settings=null,templates=null,broadcasts=null,employees=null,dashboard=null,dashboardBefore=null,ordersPending=false,textKey='new_order';
 var channelRows=[['new_order','Новые заявки','Новый заказ: номер, дата, время, адрес и услуга'],['order_changed','Изменения заказов','Если поменялись дата, время, адрес или услуга'],['order_cancelled','Отмена заказа','Сразу сообщать руководителю об отмене'],['subscriptions','Абонементы','Закончился, осталась 1 уборка или данные требуют проверки'],['defects','Дефекты до уборки','Фото и комментарий по найденному дефекту'],['finance_changes','Финансы и реквизиты','Изменения реквизитов сотрудников']];
 var textRows=[['new_order','Новая заявка','Автоматическое сообщение руководителю'],['order_changed','Изменение заказа','Когда изменились данные заказа'],['order_cancelled','Отмена заказа','Когда заказ отменён'],['subscriptions','Абонемент','Когда абонемент закончился, осталась 1 уборка или нужна проверка'],['defects','Дефект до уборки','Подпись к фото дефекта для руководителя'],['finance_changes','Реквизиты сотрудника','Когда сотрудник меняет реквизиты'],['broadcast','Рассылка','Шаблон ручных сообщений команде']];
 var sample={order:'Заказ #30',date:'18.09.2026',time:'14:30',address:'Санкт-Петербург, Невский проспект, 10',service:'Генеральная уборка',area:'65 м²',comment:'Царапина на столешнице',employee:'Алексей',client:'Анна',subscription:'Поддерживающая уборка',remaining:'1',title:'Изменение графика',body:'Завтра начинаем на час позже.',brand:'HOUSE CLEANING STAFF'};
 ...
 function fmt(ts){try{return new Date(Number(ts||0)).toLocaleString('ru-RU',{day:'2-digit',month:'2-digit',year:'numeric',hour:'2-digit',minute:'2-digit'})}catch(e){return''}}
 ...
 function icon(kind){if(kind==='important')return'!';if(kind==='order')return'▤';if(kind==='subscription')return'🎫';return'•'}
 function noticeKind(n){var s=(String(n&&n.level||'')+' '+String(n&&n.title||'')).toLowerCase();if(s.indexOf('warning')>=0||s.indexOf('отмен')>=0||s.indexOf('дефект')>=0||s.indexOf('ошиб')>=0)return'important';if(s.indexOf('абонемент')>=0)return'subscription';if(n&&n.order_number||s.indexOf('заяв')>=0||s.indexOf('заказ')>=0)return'order';return'system'}
 ...
 function upgradeNotifications(){
   ...
   tabs.innerHTML='<button data-v5-ntab="feed" class="on">Лента</button><button data-v5-ntab="channels">Что получать</button><button data-v5-ntab="texts">Тексты</button><button data-v5-ntab="broadcast">Рассылка</button>';
 ...
 async function openOrder(number){
   if(!number)return;if(window.__hcPushOrigin)window.__hcPushOrigin('notifications');window.__hcSkipOriginOnce=true;if(!navTo('orders')){window.__hcSkipOriginOnce=false;return}Promise.resolve().then(function(){var b=document.querySelector('[data-order="'+CSS.escape(number)+'"]');if(b)b.click();else{window.__hcSkipOriginOnce=false;var q=document.getElementById('search');if(q){q.value=number;q.dispatchEvent(new Event('input',{bubbles:true}))}}});
 }
 function normalizePrefs(v){v=v||{};return{style:['balanced','compact','focus'].indexOf(v.style)>=0?v.style:'balanced',density:['comfortable','compact'].indexOf(v.density)>=0?v.density:'comfortable',motion:['gentle','full','off'].indexOf(v.motion)>=0?v.motion:'gentle',text:['normal','large'].indexOf(v.text)>=0?v.text:'normal',nav:['glass','compact'].indexOf(v.nav)>=0?v.nav:'glass',accent:['blue','graphite','mint'].indexOf(v.accent)>=0?v.accent:'blue'}}
 ...
 function applyPrefs(v){v=normalizePrefs(v);dashboard=Object.assign({},dashboard||{},v);applyDashboard(v.style);var h=document.documentElement;h.classList.remove('hc-ui-density-comfortable','hc-ui-density-compact','hc-ui-motion-gentle','hc-ui-motion-full','hc-ui-motion-off','hc-ui-text-normal','hc-ui-text-large','hc-ui-nav-glass','hc-ui-nav-compact','hc-ui-accent-blue','hc-ui-accent-graphite','hc-ui-accent-mint');h.classList.add('hc-ui-density-'+v.density,'hc-ui-motion-'+v.motion,'hc-ui-text-'+v.text,'hc-ui-nav-'+v.nav,'hc-ui-accent-'+v.accent)}
 async function loadDashboard(){if(dashboard){applyPrefs(dashboard);return dashboard}try{var cached=JSON.parse(localStorage.getItem('hc:ui:prefs')||'null');if(cached){dashboard=normalizePrefs(cached);applyPrefs(dashboard)}}catch(e){}if(!dashboard){dashboard=normalizePrefs({});applyPrefs(dashboard)}try{var x=await api('/api/staff/dashboard-preferences'),next=normalizePrefs(x.preferences);dashboard=next;applyPrefs(next);try{localStorage.setItem('hc:ui:prefs',JSON.stringify(next))}catch(e){}}catch(e){}return dashboard}
 async function decorateOverview(main){var head=main.querySelector('.hc-v3-command-head');if(!head)return;if(!dashboard)loadDashboard();if(head.querySelector('.hc-v5-view-button'))return;var b=document.createElement('button');b.className='hc-v5-view-button';b.type='button';b.dataset.v5View='1';b.innerHTML='<svg viewBox="0 0 24 24"><path d="M4 7h10M18 7h2M4 12h3M11 12h9M4 17h7M15 17h5"/><circle cx="16" cy="7" r="2"/><circle cx="9" cy="12" r="2"/><circle cx="13" cy="17" r="2"/></svg>Настроить';head.appendChild(b)}
 function openDashboardSheet(){
   dashboardBefore=Object.assign({},normalizePrefs(dashboard));var old=document.getElementById('hcV5DashSheet');if(old)old.remove();
   var mask=document.createElement('div');mask.id='hcV5DashSheet';mask.className='hc-v5-sheet-mask';
   mask.innerHTML='<div class="hc-v5-sheet"><div class="hc-v5-sheet-head"><strong>Настроить приложение</strong><button data-v5-dash-close>×</button></div><div class="hc-v5-app-preview"><div class="hc-v5-app-preview-top"><strong>Предпросмотр</strong><span>изменения видны сразу</span></div><div class="hc-v5-preview-phone"><div class="hc-v5-preview-row"><i></i><i></i><i></i></div><div class="hc-v5-preview-card"></div><div class="hc-v5-preview-card"></div><div class="hc-v5-preview-nav"><i></i><i></i><i></i><i></i><i></i></div></div></div><div class="hc-v5-pref-group"><strong>Главная</strong><div class="hc-v5-pref-row"><button data-v5-dash-style="balanced">Карточки</button><button data-v5-dash-style="compact">Компактно</button><button data-v5-dash-style="focus">Фокус</button></div></div><div class="hc-v5-pref-group"><strong>Карточки</strong><div class="hc-v5-pref-row two"><button data-v5-pref="density" data-v5-value="comfortable">Удобные</button><button data-v5-pref="density" data-v5-value="compact">Плотные</button></div></div><div class="hc-v5-pref-group"><strong>Текст</strong><div class="hc-v5-pref-row two"><button data-v5-pref="text" data-v5-value="normal">Обычный</button><button data-v5-pref="text" data-v5-value="large">Крупнее</button></div></div><div class="hc-v5-pref-group"><strong>Нижнее меню</strong><div class="hc-v5-pref-row two"><button data-v5-pref="nav" data-v5-value="glass">Стекло</button><button data-v5-pref="nav" data-v5-value="compact">Компактное</button></div></div><div class="hc-v5-pref-group"><strong>Акцент</strong><div class="hc-v5-pref-row"><button data-v5-pref="accent" data-v5-value="blue">Синий</button><button data-v5-pref="accent" data-v5-value="graphite">Графит</button><button data-v5-pref="accent" data-v5-value="mint">Мята</button></div></div><div class="hc-v5-pref-group"><strong>Анимация</strong><div class="hc-v5-pref-row"><button data-v5-pref="motion" data-v5-value="off">Без</button><button data-v5-pref="motion" data-v5-value="gentle">Лёгкая</button><button data-v5-pref="motion" data-v5-value="full">Полная</button></div></div><div class="hc-v5-sheet-actions"><button class="cancel" data-v5-dash-close>Отмена</button><button class="save" data-v5-dash-save>Сохранить</button></div></div>';
   document.body.appendChild(mask);paintPrefs();
 }
 function paintPrefs(){var p=normalizePrefs(dashboard);document.querySelectorAll('[data-v5-dash-style]').forEach(function(b){b.classList.toggle('on',b.dataset.v5DashStyle===p.style)});document.querySelectorAll('[data-v5-pref]').forEach(function(b){b.classList.toggle('on',p[b.dataset.v5Pref]===b.dataset.v5Value)})}
 function selectDashboardChoice(style){dashboard=Object.assign({},normalizePrefs(dashboard),{style:style});applyPrefs(dashboard);paintPrefs()}
 function selectPreference(key,value){var next=Object.assign({},normalizePrefs(dashboard));next[key]=value;dashboard=next;applyPrefs(next);paintPrefs()}
 function closeDashboardSheet(revert){var m=document.getElementById('hcV5DashSheet');if(m)m.remove();if(revert&&dashboardBefore){dashboard=Object.assign({},dashboardBefore);applyPrefs(dashboard)}}
 async function saveDashboard(){try{var prefs=normalizePrefs(dashboard),x=await api('/api/staff/dashboard-preferences',{method:'POST',body:{preferences:prefs}});dashboard=normalizePrefs(x.preferences||prefs);applyPrefs(dashboard);try{localStorage.setItem('hc:ui:prefs',JSON.stringify(dashboard))}catch(e){}closeDashboardSheet(false);toast('Вид приложения сохранён','success')}catch(e){toast(e.message,'error')}}
 ...
 function decorateMore(main){if(document.getElementById('hcV5AppSettings'))return;var grid=main.querySelector(':scope>.grid');if(!grid)return;var b=document.createElement('button');b.type='button';b.id='hcV5AppSettings';b.className='card';b.style.textAlign='left';b.innerHTML='<div class="title">⚙ Настроить приложение</div><div class="sub">Главная, плотность и анимации</div>';grid.appendChild(b)}
 function queue(){if(queued)return;queued=true;try{var main=document.getElementById('main');if(!main)return;var p=currentPage();if(p==='overview')decorateOverview(main);if(p==='orders')decorateOrders(main);if(p==='notifications')upgradeNotifications();if(activeTab()==='more')decorateMore(main)}finally{queued=false}}
 ...
 document.addEventListener('click',function(e){var t=e.target;if(!t||!t.closest)return;
   ...
   if(t.closest('[data-v5-view],#hcV5AppSettings')){e.preventDefault();loadDashboard().then(openDashboardSheet).catch(function(x){toast(x.message,'error')});return}
 ...
 try{var first=JSON.parse(localStorage.getItem('hc:ui:prefs')||'null');dashboard=normalizePrefs(first||{});applyPrefs(dashboard)}catch(e){dashboard=normalizePrefs({});applyPrefs(dashboard)}
