...
(function(){
  ...
  var settingRows=[['new_order','Новые заявки','Сообщать руководителю о новом заказе'],['order_changed','Изменения заказов','Дата, время, адрес и состав услуги'],['order_cancelled','Отмена заказа','Сразу сообщать руководителю об отмене'],['subscriptions','Абонементы','Остаток, окончание и записи на проверку'],['defects','Дефекты до уборки','Фото и комментарий по найденному дефекту'],['finance_changes','Финансы и реквизиты','Изменения реквизитов сотрудников']];
