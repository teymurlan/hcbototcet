...
const BUILD='staff-human-orders-2026-09-16-g';
...
export default {
  async fetch(req:Request,env:Env,ctx?:ExecutionContext):Promise<Response>{
    ...
    if(req.method==='GET'&&u.pathname==='/__hc_staff_version'){
      ...
      return J({...info,ok:true,build:BUILD,human_order_numbers:true,compact_order_cards:true,dense_order_cards:true,sticky_staff_header:true,standards_carousel_fixed:true,pastel_standard_cards:true,continuous_standard_depth:true,dense_operational_cells:true,premium_button_system:true,compact_glass_nav:true,stable_rerender_labels:true,stable_orders_screen:true,standards_motion:true,event_driven_ui:true,no_dom_polling:true,app_motion_system:true,moving_nav_indicator:true,native_toasts:true,screen_motion:true,sheet_motion:true,media_fade:true,reduced_motion:true,logic_unchanged:true});
    }
